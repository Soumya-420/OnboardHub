                ...
                <div className="text-center max-w-5xl mx-auto space-y-8 mb-24">
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative flex p-2 bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl">
                                ...
                                <button type="submit" className="px-6 py-3 bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold rounded-xl hover:scale-110 hover:shadow-[0_0_30px_rgba(239,68,68,0.6)] transition-all flex items-center justify-center gap-2 shadow-lg group">
                        ...
                        <div className="mt-6 flex justify-center gap-6 text-sm text-gray-500">
                            <Link
                                ...
                                className="px-5 py-2 bg-yellow-500/10 border border-yellow-500/50 rounded-full text-yellow-300 hover:bg-yellow-500 hover:text-black transition-all flex items-center gap-2 shadow-[0_0_15px_rgba(234,179,8,0.3)] hover:shadow-[0_0_25px_rgba(234,179,8,0.6)] hover:scale-105 group"
                            >
